...
public class GetCapabilitiesLayerScaleDenominatorsTest extends AbstractBaseGetCapabilitiesFixture {
	...
	@Test(description = "DGIWG - Web Map Service 1.3 Profile, 6.6.2.3., S.15, Requirement 18",
			dataProvider = "layerNodes")
	public void wmsCapabilitiesLayerScaleDenominatorsExists(Node layerNode, String name, String title)
