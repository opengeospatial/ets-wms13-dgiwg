...
public class WmsClient {
	...
	/**
	 * Constructs a client that is aware of the capabilities of some WMS. The request and
	 * response may be logged to a default JDK logger (in the namespace
	 * "com.sun.jersey.api.client").
	 * @param wmsCapabilities the WMS capabilities document, never <code>null</code>
	 */
	...
	/**
	 * Retrieves a complete representation of the capabilities document from the WMS
	 ...
	 * @param payload the payload in XML format
