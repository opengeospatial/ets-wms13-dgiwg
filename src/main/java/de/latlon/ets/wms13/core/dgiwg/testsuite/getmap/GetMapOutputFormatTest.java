...
public class GetMapOutputFormatTest extends BaseGetMapFixture {
	...
	@Test(description = "DGIWG - Web Map Service 1.3 Profile, 6.5.3.2., S.9, Requirement 5",
			dependsOnMethods = "wmsCapabilitiesOutputFormatImagePngSupported")
	...
	@Test(description = "DGIWG - Web Map Service 1.3 Profile, 6.5.3.2., S.9, Requirement 5",
			dependsOnMethods = "wmsCapabilitiesOutputFormatImageGifSupported")
	...
	@Test(description = "DGIWG - Web Map Service 1.3 Profile, 6.5.3.2., S.9, Requirement 5",
			dependsOnMethods = "wmsCapabilitiesOutputFormatImageJpegSupported")
