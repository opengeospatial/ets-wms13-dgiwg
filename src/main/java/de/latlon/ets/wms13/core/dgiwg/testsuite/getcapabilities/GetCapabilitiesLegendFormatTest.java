...
public class GetCapabilitiesLegendFormatTest extends AbstractBaseGetCapabilitiesFixture {
    ...
    public void wmsCapabilitiesLayersLegendExistsInCorrectFormat( ITestContext testContext, Node layerNode,
    ...
    /*
     * private void skipIfNoVectorData( ITestContext testContext ) { boolean isVector = (boolean)
     * testContext.getSuite().getAttribute( SuiteAttribute.IS_VECTOR.getName() ); if ( !isVector ) throw new
     * SkipException( "WMS does not contain vector data layers, tests are skipped!" ); }
     */
}