...
public class NumberDimensionIntervalTest {
	...
	@Test
	public void testRetrieveRequestableValue_Int() throws Exception {
		Number min = 1;
		Number max = 10;
		Number resolution = 1;
	...
	@Test
	public void testRetrieveRequestableValue_Decimal() throws Exception {
		Number min = 1.9;
		Number max = 2.6;
	...
	@Test
	public void testRetrieveRequestableValue_EmptyDayInterval() throws Exception {
		Number min = 1;
		Number max = 1;
		Number resolution = 1;
		NumberDimensionInterval interval = new NumberDimensionInterval(min, max, resolution);
	...
	@Test
	public void testRetrieveRequestableValue_ZeroResolution() throws Exception {
		Number min = 1;
		Number max = 1;
		Number resolution = 0;
		NumberDimensionInterval interval = new NumberDimensionInterval(min, max, resolution);
	...
	private Number asNumber(String number) throws ParseException {
